    ...
    <div class="maincontainer2">
        <div class="innercontainer2">
            ...
            <div class="right">
                ...
                <form method="post" action="{{url('search-category')}}">
                    {{csrf_field()}}
                    <table class="uppertable">
                        ...
                        <tr>
                            <td>Search Category Here :</td>
                            <td><input type="text" name="categoryname"><input type="submit" name="search" value="Search" class="button"></td>
                        </tr>
                    </table>
                </form>
                ...
                <table class="righttable">
                    ...
                    <tr class="tr2">
                        <td>{{$row->id}}</td>
                        <td>{{$row->category}}</td>
                        <td><a href="{{'edit-category/'.$row->id}}"><i class="fa-sharp fa-solid fa-pen"></i></td>
                        <td><a href="{{'delete-category/'.$row->id}}"><i class="fa-solid fa-trash"></i></td>
                    </tr>
                    @endforeach
                    <tr>
